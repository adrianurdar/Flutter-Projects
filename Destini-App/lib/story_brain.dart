...
class StoryBrain {
  ...
  // include storyData as a private property in StoryBrain.
  ...
  // Use the storyNumber property inside getStory(), getChoice1() and
  // getChoice2() so that it gets the updated story and choices rather than
  ...
  // Create a method called getChoice1() that returns the text for the first
  // choice1 from _storyData.
  String getChoice1() => _storyData[_storyNumber].choice1;

  // Create a method called getChoice2() that returns the text for the first
  // choice2 from _storyData.
  ...
  // Create a method called nextStory(), it should not have any outputs but it
  // should have 1 input called choiceNumber which will be the choice number
  // (int) made by the user.
  void nextStory(int choiceNumber) {

    // Using the story plan, update nextStory() to change the storyNumber
    // depending on the choice made by the user. e.g. if choiceNumber was equal
    // to 1 and the storyNumber is 0, the storyNumber should become 2.
    ...
    // it's the end of the game and it should call a method called restart()
  ...
  // Create a method called buttonShouldBeVisible() which checks to see if
  // storyNumber is 0 or 1 or 2 (when both buttons should show choices) and
